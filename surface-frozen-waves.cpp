...
{
    puts("\n| SCALAR-SURFACE-FROZEN-WAVES | 16 MAR 2021 | @JODESARRO |\n");
    puts("DESCRIPTION");
                            ...
                            complex<double> * h, double * Q, double * L, int IQMAX, int IPMAX )
{
    ...
    if ( parameters.method == "traditional_resistant" || parameters.method == "traditional_nonresistant" )
    {
        // Eqs (2)-(4) of [4].
                              ...
                              int IIMAX, int IKMAX )
{
  ...
  if ( parameters.method == "traditional_nonresistant" )
    {
